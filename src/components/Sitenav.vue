<template>
    ...
    <ul class="sitenav-items list-nostyle list-inline">
      <li class="sitenav-list">
        <router-link to="/articles" class="sitenav-anchor" :class="{'is-active': scrollPointer.onArticle}">articles</router-link>
      </li>
      <li class="sitenav-list">
        <router-link to="/media" class="sitenav-anchor" :class="{'is-active': scrollPointer.onMedia}">media</router-link>
      </li>
      <li class="sitenav-list">
        <router-link to="/about" class="sitenav-anchor" :class="{'is-active': scrollPointer.onAbout}">story</router-link>
      </li>
      <li class="sitenav-list">
        <router-link to="/connect" class="sitenav-anchor">connect</router-link>
      </li>
    </ul>
  </nav>
</template>
